...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon"
        href="{{ asset(admin_file_root()) }}/app-assets/images/ico/favicon.ico">
    ...
    <link rel="stylesheet" type="text/css"
        href="{{ asset(admin_file_root() . '/app-assets/vendors/css/extensions/sweetalert2.min.css') }}">
    <!-- END: Vendor CSS-->
    ...
    <!-- BEGIN: Vendor CSS-->
    <link rel="stylesheet" type="text/css"
        href="{{ asset(admin_file_root()) }}/app-assets/vendors/css/vendors.min.css">
    <link rel="stylesheet" type="text/css"
    ...
    <link rel="stylesheet" href="{{ asset(main_root() . '/admin/assets/css/custom.css') }}">
    <style>
        body {
            background: #ffffff;
        }
...
<body class="vertical-layout vertical-menu-modern 2-columns  navbar-sticky footer-static  " data-open="click"
                    ...
                    <ul class="nav navbar-nav float-right">
                                        ...
                                        <div class="media d-flex align-items-center">
                                            ...
                                            <div class="media-body">
                                                <h6 class="media-heading"><span
                                                        class="text-bold-500">Application</span> has
                                                    been approved</h6><small class="notification-text">6 hrs
                                                    ago</small>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="media d-flex align-items-center">
                                            ...
                                            <div class="media-body">
                                                <h6 class="media-heading"><span class="text-bold-500">New file</span>
                                                    has
                                                    been uploaded</h6><small class="notification-text">4 hrs
                                                    ago</small>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="d-flex justify-content-between cursor-pointer">
                                        <div class="media d-flex align-items-center border-0">
                                            ...
                                            <div class="media-body">
                                                <h6 class="media-heading"><span class="text-bold-500">New
                                                        customer</span>
                                                    comment received</h6><small class="notification-text">2 days
                                                    ago</small>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <li class="dropdown dropdown-user nav-item"><a
                            ...
                            <div class="dropdown-menu dropdown-menu-right pb-0">
                                <a class="dropdown-item" href="{{ url('admin/secured/profile/update') }}"><i
                                        class="bx bx-user mr-50"></i>
                                    Edit Profile</a>
                                <a class="dropdown-item" href=""><i class="bx bx-envelope mr-50"></i> My
                                    Inbox</a>
            ...
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation"
                ...
                <li class="@if ($route == 'admin.vipslider.index') active @else @endif">
                    <a href="{{ route('admin.vipslider.index') }}"><i class="bx bx-right-arrow-alt"></i><span
                            class="menu-item" data-i18n="Section">Slider</span></a>
                </li>
                ...
                <li class="@if ($route == 'admin.package.index') active @else @endif">
                    <a href="{{ route('admin.package.index') }}"><i class="bx bx-right-arrow-alt"></i><span
                            class="menu-item" data-i18n="Section">Manage Plan</span></a>
                </li>
                ...
                <li class="@if ($route == 'admin.rebate.index') active @else @endif">
                    <a href="{{ route('admin.rebate.index') }}"><i class="bx bx-right-arrow-alt"></i><span
                            class="menu-item" data-i18n="Section">Rebate Commission</span></a>
                </li>
                ...
                <li class="@if ($route == 'admin.customer.index') active @else @endif">
                    <a href="{{ route('admin.customer.index') }}"><i class="bx bx-right-arrow-alt"></i><span
                            class="menu-item" data-i18n="Section">Manage Customers</span></a>
                </li>
                    ...
                    <ul class="menu-content">
                        <li class="@if ($route == 'admin.payment.pending') active @else @endif">
                            <a href="{{ route('admin.payment.pending') }}"><i class="bx bx-right-arrow-alt"></i><span
                                    class="menu-item" data-i18n="Section">Pending Payment</span></a>
                        </li>
                        <li class="@if ($route == 'admin.payment.approved') active @else @endif">
                            <a href="{{ route('admin.payment.approved') }}"><i
                                    class="bx bx-right-arrow-alt"></i><span class="menu-item"
                                    data-i18n="Section">Approved Payment</span></a>
                        </li>
                        <li class="@if ($route == 'admin.payment.rejected') active @else @endif">
                            <a href="{{ route('admin.payment.rejected') }}"><i
                                    class="bx bx-right-arrow-alt"></i><span class="menu-item"
                                    data-i18n="Section">Rejected Payment</span></a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="nav-item @if ($route == 'admin.withdraw.pending' || $route == 'admin.withdraw.rejected' || $route == 'admin.withdraw.approved') sidebar-group-active open active @else @endif">
                    <a href="#"> <i class="bx bx-right-arrow"></i> <span class="menu-title"
                            data-i18n="Invoice">Customer Withdraws</span></a>
                    <ul class="menu-content">
                        <li class="@if ($route == 'admin.withdraw.pending') active @else @endif">
                            <a href="{{ route('admin.withdraw.pending') }}"><i
                                    class="bx bx-right-arrow-alt"></i><span class="menu-item"
                                    data-i18n="Section">Pending Withdraw</span></a>
                        </li>
                        <li class="@if ($route == 'admin.withdraw.approved') active @else @endif">
                            <a href="{{ route('admin.withdraw.approved') }}"><i
                                    class="bx bx-right-arrow-alt"></i><span class="menu-item"
                                    data-i18n="Section">Approved Withdraw</span></a>
                        </li>
                        <li class="@if ($route == 'admin.withdraw.rejected') active @else @endif">
                            <a href="{{ route('admin.withdraw.rejected') }}"><i
                                    class="bx bx-right-arrow-alt"></i><span class="menu-item"
                                    data-i18n="Section">Rejected Withdraw</span></a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="nav-item @if (
                    $route == 'admin.method.index' ||
                        ...
                        $route == 'admin.method.insert' ||
                        $route == 'admin.hiruslider.index' ||
                        $route == 'admin.hiruslider.create' ||
                        $route == 'admin.hiruslider.insert') sidebar-group-active open active @else @endif">
                    <a href="#"> <i class="bx bx-right-arrow"></i> <span class="menu-title"
                    ...
                    <ul class="menu-content">
                        <li class="@if ($route == 'admin.method.index' || $route == 'admin.method.create' || $route == 'admin.method.insert') active @else @endif">
                            <a href="{{ route('admin.method.index') }}"><i class="bx bx-right-arrow-alt"></i><span
                                    class="menu-item" data-i18n="Section">Manage Methods</span></a>
                        </li>
                        ...
                        <li class="@if ($route == 'admin.setting.index' || $route == 'admin.setting.create' || $route == 'admin.setting.insert') active @else @endif">
                            <a href="{{ route('admin.setting.index') }}"><i class="bx bx-right-arrow-alt"></i><span
                                    class="menu-item" data-i18n="Section">Settings</span></a>
                        </li>
                        ...
                        <li class="@if ($route == 'admin.developer.index') active @else @endif">
                            <a href="{{ route('admin.developer.index') }}"><i class="bx bx-right-arrow-alt"></i><span
                                    class="menu-item" data-i18n="Section">Developer Section</span></a>
                        </li>
                    </ul>
                </li>
            </ul>
    ...
    <!-- BEGIN: Vendor JS-->
    <script src="{{ asset(main_root() . '/admin/app-assets/vendors/js/vendors.min.js') }}"></script>
    <script src="{{ asset(main_root() . '/admin/app-assets/fonts/LivIconsEvo/js/LivIconsEvo.tools.js') }}"></script>
    <script src="{{ asset(main_root() . '/admin/app-assets/fonts/LivIconsEvo/js/LivIconsEvo.defaults.js') }}"></script>
    <script src="{{ asset(main_root() . '/admin/app-assets/fonts/LivIconsEvo/js/LivIconsEvo.min.js') }}"></script>
    <!-- BEGIN Vendor JS-->

    <!-- BEGIN: Page Vendor JS-->
    <script src="{{ asset(main_root() . '/admin/app-assets/vendors/js/charts/apexcharts.min.js') }}"></script>
    <script src="{{ asset(main_root() . '/admin/app-assets/vendors/js/extensions/swiper.min.js') }}"></script>
    <!-- END: Page Vendor JS-->

    <!-- BEGIN: Theme JS-->
    <script src="{{ asset(main_root() . '/admin/app-assets/js/scripts/configs/vertical-menu-light.js') }}"></script>
    <script src="{{ asset(main_root() . '/admin/app-assets/js/core/app-menu.js') }}"></script>
    <script src="{{ asset(main_root() . '/admin/app-assets/js/core/app.js') }}"></script>
    <script src="{{ asset(main_root() . '/admin/app-assets/js/scripts/components.js') }}"></script>
    <script src="{{ asset(main_root() . '/admin/app-assets/js/scripts/footer.js') }}"></script>
    <!-- END: Theme JS-->

    <!-- BEGIN: Page Vendor JS-->
    <script src="{{ asset(admin_file_root()) }}/app-assets/vendors/js/tables/datatable/datatables.min.js"></script>
    <script src="{{ asset(admin_file_root()) }}/app-assets/vendors/js/tables/datatable/dataTables.bootstrap4.min.js">
    </script>
    ...
    <script src="{{ asset(main_root() . '/common/sweetalert2.js') }}"></script>
    <script src="{{ asset(main_root() . '/common/developer.js') }}"></script>
    <!-- END: Page JS-->
    @stack('scripts')
</body>
