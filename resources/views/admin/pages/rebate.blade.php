                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <input type="text" class="form-control is-valid"
                                                    ...
                                                    value="{{ $data ? $data->first_level_percentage : old('first_level_percentage') }}">
                                                <div class="valid-feedback">
                                                    <i class="bx bx-radio-circle"></i>
                                                    Note: This is filed is optional
                                                </div>
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <input type="text" class="form-control is-valid"
                                                    ...
                                                    value="{{ $data ? $data->second_level_percentage : old('second_level_percentage') }}">
                                                <div class="valid-feedback">
                                                    <i class="bx bx-radio-circle"></i>
                                                    Note: This is filed is optional
                                                </div>
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <input type="text" class="form-control is-valid"
                                                    ...
                                                    value="{{ $data ? $data->third_level_percentage : old('third_level_percentage') }}">
                                                <div class="valid-feedback">
                                                    <i class="bx bx-radio-circle"></i>
                                                    Note: This is filed is optional
                                                </div>
