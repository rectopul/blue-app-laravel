        ...
        <uni-page-head uni-page-head-type="default">
            <div class="uni-page-head" style="background-color: rgb(13, 165, 97); color: rgb(255, 255, 255);">
                ...
                <div class="uni-page-head-bd">
                    <div class="uni-page-head__title" style="font-size: 16px; opacity: 1;"> Withdraw record</div>
                </div>
                <div class="uni-page-head-ft"></div>
            </div>
                                ...
                                @foreach(\App\Models\Withdrawal::where('user_id', auth()->id())->orderByDesc('id')->get() as $element)
                                    <uni-view data-v-52b6708e="" class="item">
                                        <uni-view data-v-52b6708e="" class="item_t">
                                            ...
                                            <uni-view data-v-52b6708e="" class="types">Withdraw</uni-view>
                                            <uni-view data-v-52b6708e="" class="con">
                                                ...
                                                <uni-view data-v-52b6708e="" class="conitem">
                                                    <uni-view data-v-52b6708e="" class="lab">Withdraw Date</uni-view>
