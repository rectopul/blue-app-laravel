...
<div x-data class="flex min-h-screen flex-col bg-gradient-to-b from-[#FFF5F8] via-[#FFEBF2] to-[#F0F7FF] px-6 py-12">
    <div class="flex-1">
        <div class="mb-12 text-center">
            ...
            <p class="mt-3 text-sm font-medium text-slate-400">
                Acesse sua conta para gerenciar seus ovos.
            </p>
        </div>
            ...
            <form action="{{ route('login.submit') }}" method="POST" class="space-y-6">
                ...
                <div class="space-y-2">
                    <div class="flex items-center justify-between px-1">
                        <label for="password" class="text-[11px] font-bold uppercase tracking-[0.2em] text-slate-400">Senha</label>
                        <a href="#" class="text-[10px] font-bold text-pink-500 uppercase tracking-wider">Esqueceu?</a>
                    </div>
                    <div class="relative flex items-center">
                ...
                <div class="flex items-center gap-3 px-1 pt-2">
                    <input type="checkbox" id="remember" name="remember-me" class="h-5 w-5 rounded-lg border-slate-200 text-pink-500 focus:ring-pink-200 cursor-pointer">
                    <label for="remember" class="text-xs font-bold text-slate-400 cursor-pointer select-none">Manter conectado</label>
                </div>
    ...
    <div class="mt-12 text-center">
        <p class="text-sm font-medium text-slate-400">
            Não tem uma conta?
            <a href="{{ route('register') }}" class="font-bold text-pink-500 hover:text-pink-600 underline-offset-4 hover:underline">
