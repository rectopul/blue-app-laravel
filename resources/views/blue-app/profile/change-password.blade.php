    ...
    <div class="pb-32">
        <div class="relative overflow-hidden rounded-b-[40px] bg-gradient-to-b from-[#FFF5F8] via-[#FFEBF2] to-[#F0F7FF] px-5 pt-8 pb-10">
            <div class="flex items-center justify-between">
                ...
                <h1 class="text-[22px] font-bold tracking-tight text-slate-800">Trocar <span class="text-pink-500">Senha</span></h1>
                <div class="w-12"></div>
            </div>

            <div class="mt-8 text-center">
                <p class="mb-1 text-[11px] font-bold uppercase tracking-[0.2em] text-pink-400">Segurança da Conta</p>
                <h2 class="text-xl font-black text-slate-800">Alterar Senha de Login</h2>
            </div>
        </div>

        <div class="-mt-6 px-5">
            <div class="rounded-[40px] border border-pink-50 bg-white p-7 shadow-xl shadow-black/5">
                <form action="{{ route('user.change.password.confirmation') }}" method="POST" class="space-y-5">
                    @csrf

                    <div class="space-y-1.5" x-data="{ show: false }">
                        <label class="ml-4 text-[10px] font-bold uppercase tracking-widest text-slate-400">Senha Atual</label>
                    ...
                    <div class="space-y-1.5" x-data="{ show: false }">
                        <label class="ml-4 text-[10px] font-bold uppercase tracking-widest text-slate-400">Nova Senha</label>
                        <div class="relative flex items-center">
