...
class RebateController extends Controller
{
    ...
    public function insert_or_update(Request $request)
    {
        ...
        $model->first_level_percentage = $request->interest_commission1;
        $model->second_level_percentage = $request->interest_commission2;
        $model->third_level_percentage = $request->interest_commission3;
